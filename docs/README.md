...
The static file [`index.html`](index.html) is the **GitHub Pages** landing page used as Supabase **Site URL** / **Redirect URL** for email confirmation (see repo Settings → Pages).
